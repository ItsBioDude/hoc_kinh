...
<!-- <Fullpage> -->
<main
	class="grid h-screen w-screen overflow-y-hidden sm:grid-cols-[70vw_30vw] lg:grid-cols-[1.7fr_1fr] grid-rows-[45vh_55vh] font-title overflow-hidden bg-orange-200 dark:bg-gray-800 text-center"
>
